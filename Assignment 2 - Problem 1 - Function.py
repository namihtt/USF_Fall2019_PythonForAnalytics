...
Date: 10/27/2019
Comments: Fall 2019 - Python for Analytics - Assignment 2 -  Functions: Problem 1:
'''
...
try: # check for errors
    def miles(x): #define function
        distance = 10 #declare variable and the starting number of the counting
        while distance > 1: #run the loop while distance is still more than 0
